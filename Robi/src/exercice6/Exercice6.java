...
/**
 * Exercice 6 : Scripts utilisateur (addScript) et macro-expansion.
 * Les elements graphiques peuvent definir leurs propres scripts.
 * Commandes ajoutees : addScript, clear.
 */
public class Exercice6 {
    ...
    /**
     * Initialise l'environnement avec les commandes de scripting
     * et ouvre l'espace graphique.
     */
    public Exercice6() {
        Environment env = interpreter.getEnvironment();

        GSpace space = new GSpace("Exercice 6", new Dimension(200, 150));
        space.open();
